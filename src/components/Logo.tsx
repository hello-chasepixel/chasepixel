...
const Logo = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 233 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    {/* "s" in acid yellow */}
    <path className="fill-acid" d="M77.727 27.01V17.908C82.611 17.908 84.313 16.65 87.051 9.76801C89.419 3.81101 92.638 1.11001 98.743 1.11001H100.001V10.175H99.964C97.078 10.175 96.042 12.802 94.525 16.983C92.009 23.902 87.384 27.01 80.132 27.01H77.727Z"/>
    <g className="fill-foreground">
